...
describe("BiometricSettings", () => {
  ...
  it("shows loading state initially", () => {
    (BiometricService.isBiometricAvailable as jest.Mock).mockResolvedValue(
      true,
    );
  ...
  it("shows not available message when biometric is not available", async () => {
    ...
    await waitFor(() => {
      expect(
        getByText("Biometric authentication is not available on this device."),
      ).toBeTruthy();
    });
  });
  ...
  it("handles enabling biometric authentication", async () => {
    ...
    (BiometricService.enableBiometric as jest.Mock).mockResolvedValue(
      undefined,
    );
  ...
  it("handles disabling biometric authentication", async () => {
    ...
    (BiometricService.disableBiometric as jest.Mock).mockResolvedValue(
      undefined,
    );
