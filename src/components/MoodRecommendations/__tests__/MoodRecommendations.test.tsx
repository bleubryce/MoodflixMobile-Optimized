...
describe("MoodRecommendations", () => {
  ...
  it("displays loading state initially", () => {
    const { getByTestId } = render(<MoodRecommendations mood="happy" />);
  ...
  it("displays recommendations when loaded successfully", async () => {
    ...
    const { getByText } = render(<MoodRecommendations mood="happy" />);
  ...
  it("calls onMoviePress when a movie is pressed", async () => {
    ...
    const { getByTestId } = render(
      <MoodRecommendations mood="happy" onMoviePress={onMoviePress} />,
    );
